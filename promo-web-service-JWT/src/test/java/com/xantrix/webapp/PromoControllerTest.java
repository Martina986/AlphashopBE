...
@ContextConfiguration(classes = PromoApplication.class)
@SpringBootTest
...
public class PromoControllerTest
{
	...
	public void L_testListPromoActive() throws Exception
	{
		mockMvc.perform(MockMvcRequestBuilders.get("/api/promo/active")
				...
				.andExpect(jsonPath("$[0].dettPromo[0].prezzo").value(BigDecimal.valueOf(0))) // Prezzo ricavato dal servizio articoli
